<%-- 
    Document   : salesBill
    Created on : 05-Apr-2024, 3:28:02 pm
    Author     : admin
--%>
...
<body>
        ...
        <div class="billContainer">
            <div class="billDetails">
                <div class="billDetails1">
                    <table>
                        <tr>
                            <td style="background: #007bff; color: white; text-align: center;">Sale No.</td>
                            <td>: <input id="invoiceNo" type="number" name=""></td>
                        </tr>
                        <tr>

                            <td>Customer Name</td>
                            <td>: <input id="customerName" list="CName" onkeyup="return suggestion('suggestCustomer')" type="text" >
                                <datalist id="CName"></datalist>
                            </td>
                        </tr>
            ...
            <div class="productDetails">
                <div id="invoice-container">
                    <table id="invoice-table" class="productDetails_table">
                        ...
                        <tbody id="invoiceBody" class="invoiceBody">
                            <tr class="inputRow">
                                <td>1</td>
                                <td><input id="" type="text" class="productName" list="pName" onkeyup="return suggestion('suggestProduct')" onkeydown="createNewRow(event)" >
                                        <datalist id="pName"></datalist>
                                </td>
                                <td><input id="" type="number" class="quantity" onkeydown="createNewRow(event)" oninput ="return calculateAmount(this)"></td>
                                <td><input id="" type="text" class="unit" list="unitList"  onkeydown="createNewRow(event)" >
                ...
                <div class="billFooter">
                    ...
                    <div class="billFooter-2">
                        ...
                        <!--<p><input type="button" onclick="return addSales()" value="Save"></p>-->
                    </div>
            ...
            <div class="billButtons">
                ...
                <div>
                    <button  class="saveButton" onclick="return addSales()">Save</button>
    ...
    <c:if test="${process eq 'viewAllSales'}" >
        <table>
            <thead>
                <tr>
                    <th>Invoice No.</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button id="deleteSales"  onclick="return viewIndividualSale(<%= rs.getInt(1)%>, 'deleteIndividualSale')">Delete </button></td>    
                </tr>
                <%
                    }
                %>
    ...
    <c:if test="${process eq 'viewIndividualSale'}" >
                ...
                <div class="billDetails1">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>Customer Name</td>
                            <td>: <input id="customerName" list="CName" value="<%=rs.getString(2)%>" onkeyup="return suggestion('suggestCustomer')" type="text">
                                <datalist id="CName"></datalist>
                            </td>
                        </tr>
...
<!--                    <button onclick=" return createNewRow('Enter')" >Add Row</button>-->
                    <table id="invoice-table" class="productDetails_table">
                        ...
                        <tbody id="invoiceBody">
                            ...
                            <tr class="inputRow"> 
                                ...
                                <td><button class="updateX">X</button></td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
                    ...
                    <div class="billFooter-1">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input  value="<%=rs.getInt(4)%>" type="number" id="gst" defaultValue=0 oninput="updateTotalAmt()"> %
                                </td>
                                ...
                                <td>
                                    <input  value="<%=rs.getInt(5)%>" type="number" id="freight" defaultValue=0 oninput="updateTotalAmt()"> %
                                </td>
                                ...
                                <td>
                                    <input  value="<%=rs.getInt(6)%>" type="number" id="discount" defaultValue=0 oninput="updateTotalAmt()"> %
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div>
                    <button  class="saveButton" onclick="return updateSales()">Save</button>
                    <button onclick="previewInvoice()" class="priviewButton">PreView</button>
                </div>
            </div>
        </div>
