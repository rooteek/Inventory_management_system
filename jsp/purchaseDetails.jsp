<%-- 
    ...
    Created on : 12-Mar-2024, 10:50:01 pm
    Author     : admin
--%>
        ...
        <div class="table">
            <div class="table_header">
                <div class="tableHeader1">
                    <!--<p>Product Details</p>-->
                    <button class="add_category" onclick="processMethod('purchaseBill')">+ Add New</button>
                </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button id="deletePurchase" class="deleteDataList"  onclick="return viewIndividualPurchase(<%= rs.getInt(1)%>, 'deleteIndividualPurchase')"><i class='bx bx-trash'></i> </button></td>    
                        </tr>
                        <%
                            }
                        %>
