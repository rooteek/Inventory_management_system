<%-- 
    ...
    Created on : 05-Apr-2024, 7:57:32 pm
    Author     : admin
--%>
        ...
        <div class="table">
            <div class="table_header">
                <div class="tableHeader1">
                    <!--<p>Product Details</p>-->
                    <button class="add_category" onclick="">+ Add New</button>
                </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr >
                            ...
                            <td><button id="deleteExpenses" class="deleteDataList"  onclick="return viewIndividualExpenses(<%= rs.getInt(1)%>, 'deleteIndividualExpenses')"><i class='bx bx-trash'></i> </button></td>    
                        </tr>
                        <%
                            }
                        %>
