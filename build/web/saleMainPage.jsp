<%-- 
    Document   : saleMainPage
    Created on : 06-Apr-2024, 2:15:54 pm
    Author     : admin
--%>
...
<html lang="en">
    ...
    <body onload="processMethod('dashboard')">
        <div class="sidebar">
            ...
            <a href="#"><i class='bx bxs-carousel'></i><label onclick="CustomerProcessMethod('customer')">Customer Master</label></a>
            <div class="submenu">
