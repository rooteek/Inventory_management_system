<%-- 
    Document   : customer
    Created on : 10-Mar-2024, 12:09:38 am
    Author     : admin
--%>
    ...
    <body>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="editDataList" onclick="getCustomerDetials('<%= rs.getString("CUSTOMER_ID")%>')"><i class='bx bx-edit'></i></button>
                                <button class="deleteDataList" onclick="deleteCustomerData(this)" did="<%= rs.getString("CUSTOMER_ID")%>"><i class='bx bx-trash'></i></button>
                            </td>
                        </tr>
        ...
        <div class="insert-item" id="insert-item"> 
            <div class="insert-details">
                <div class="heading">
                    <h2 class="">New Customer</h2>
                    <label for=""onclick="removePopup('add-x')">X</label>
                </div>
                <iframe src="addCustomerPage.jsp" frameborder="0"></iframe>
            </div>
        </div>
                    <!-- ----------Css in item.css----------- -->
