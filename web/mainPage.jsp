<%-- 
    Document   : mainPage
    Created on : 07-Mar-2024, 11:26:17 pm
    Author     : admin
--%>
    ...
    <body onload="processMethod('dashboard')">
        <div class="sidebar">
            <div class="dash_logo">
                ...
                <a href="">
                    <div class="mainPageLogoDesign"><img src="img/logo/logoofIn.jpg" alt=""> StockPilot</div>
                </a>
            </div>
            ...
            <div class="submenu">
                ...
                <div class="sub-content">
                    ...
                    <a href="#"><label onclick="viewCategory()">category</label></a>
            ...
            <div class="submenu">
                ...
                <div class="sub-content">
                    <a href="#"><label onclick="viewAllSales()">Sales</label></a>
                    <a href="#"><label onclick="viewAllExpenses()">Expenses</label></a>
                    <a href="#"><label onclick="viewAllPurchase()">Purchase</label></a>
                    <!--<a href="#"><label>Purchase Return</label></a>-->
                </div>
            </div>
            <a href="#"><i class='bx bx-line-chart'></i><label onclick="processMethod('stockPage')">Stock</label></a>
